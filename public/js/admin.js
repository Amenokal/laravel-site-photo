...
function addAllListeners() {
  // clicks
  document.querySelector('body').addEventListener('click', clickListeners); // drags

  document.querySelector('body').addEventListener('mousedown', dragListeners); // drops
...
function clickListeners(e) {
  ...
  if (e.target.parentNode.parentNode.parentNode.className.includes('category') || e.target.parentNode.parentNode.parentNode.className.includes('galery')) {
    type = e.target.parentNode.parentNode.parentNode.className;
  } // create category request


  if (e.target === document.getElementById('addNewCatg')) {
    var name = document.getElementById('newCatgName').value;
  ...
  if (e.target.className.includes('plus')) {
    ...
    var _name = e.target.previousElementSibling.value;
    var categoryName = e.target.parentNode.id.split('-')[1];
    ...
    var oldName = e.target.parentNode.parentNode.previousElementSibling.children[0].innerText;
    var newName = e.target.parentNode.previousElementSibling.value;
  ...
  // ---------------------
    ...
    axios.get('./galery/admin/show/' + targetName).then(function (res) {
  ...
  // choose images to upload
    ...
    var importImg = document.getElementById("photos");
    importImg.click();
    importImg.addEventListener('change', function () {
      document.getElementById('uploadBtn').classList.add('show');
      document.getElementById('uploadBtn').innerText = "T\xE9l\xE9charger ".concat(_toConsumableArray(importImg.files).length, " fichier(s)");
    });
  } // upload images
  ...
  if (e.target.className.includes('fa-star') && !e.target.className.includes('highlighted')) {
    ...
    if (e.target.className.includes('fas')) {
      ...
      var elms = e.target.parentNode.parentNode.children;
...
function dragListeners(e) {
  ...
  if (e.target.className.includes('fa-arrows-alt-v')) {
    ...
    if (target.className.includes('category')) {
      ...
      document.querySelectorAll('.category-drop-zone').forEach(function (el) {
        if (el != document.querySelector('[draggable="true"]').previousElementSibling && el != document.querySelector('[draggable="true"]').nextElementSibling) {
          el.classList.add('show');
          el.addEventListener('dragenter', function (e) {
            e.target.classList.toggle('dragged-over');
          });
      ...
      document.querySelectorAll('.dragged-from .galery-drop-zone').forEach(function (el) {
        if (el != document.querySelector('[draggable="true"]').previousElementSibling && el != document.querySelector('[draggable="true"]').nextElementSibling) {
          el.classList.add('show');
          el.addEventListener('dragenter', function (e) {
            e.target.classList.toggle('dragged-over');
  ...
  // -------------------
    ...
    document.querySelectorAll('.photo-drop-zone').forEach(function (el) {
      el.classList.add('show');
      el.addEventListener('dragenter', function (e) {
        e.target.classList.toggle('dragged-over');
      });
...
function dropListeners(e) {
  ...
  var newOrder = e.target.id.split('-')[1]; // menu drops
  ...
  if (e.target.className.includes('drop-zone') && !e.target.className.includes('photo')) {
    ...
    var id = document.querySelector('[draggable="true"]').children[0].id.split('-')[1];
    var _newOrder = e.target.id.split('-')[1];
    ...
    document.querySelectorAll('.category-drop-zone, .galery-drop-zone, .photo-drop-zone').forEach(function (el) {
      el.classList.remove('show');
    });
...
function isUsed(name) {
  var names = document.querySelectorAll('h2, h3');
  var match = false;
...
function clearFiles(withMessage) {
  ...
  var fileList = _toConsumableArray(input.files);
...
function toggleNewCatg(e) {
  var hidden = e.target.nextElementSibling;
...
function toggleNewGal(e) {
  var hidden = e.target.parentNode.parentNode.nextElementSibling.nextElementSibling;
  hidden.classList.toggle('show');
}

function addNewGal(e) {
  var name = e.target.previousElementSibling.value;
  var categoryOrder = e.target.parentNode.parentNode.parentNode.id.split('-')[1];
  "";
  axios.post('./galery/create', {
    name: name,
...
function toggleEdit(e) {
  ...
  var editContent = e.target.parentNode.parentNode.nextElementSibling;
...
function editName(e) {
  ...
  var name = input.placeholder.split('...')[0];
  var newName = input.value ? input.value : name;
  var type = e.target.parentNode.parentNode.parentNode.className.includes('catg') ? 'category' : 'galery';
  var path = './' + type + '/edit';
...
function closeEdit(e) {
  var content = e.target.parentNode.parentNode.previousElementSibling;
  var editContent = e.target.parentNode.parentNode;
  content.classList.add('show');
  editContent.classList.remove('show');
}

function remove(e) {
  var name = e.target.parentNode.previousElementSibling.innerText;
  var path;
  ...
  axios.post('./' + path + '/delete', {
    ...
    document.querySelectorAll('.fa-arrows-alt-v').forEach(function (el) {
      el.addEventListener('mousedown', allowDrag);
    });
    document.querySelectorAll('.category-drop-zone, .galery-drop-zone').forEach(function (el) {
      el.addEventListener('dragenter', function (e) {
        e.target.classList.toggle('dragged-over');
      });
      el.addEventListener('dragleave', function (e) {
...
function showGaleryContent(e) {
  var categoryOrder = e.target.parentNode.parentNode.id.split('-')[1];
  var galeryOrder = e.target.parentNode.parentNode.id.split('-')[2];
  axios.get("./galery/admin/".concat(categoryOrder, "/").concat(galeryOrder)).then(function (res) {
    document.querySelector('.admin-galery').innerHTML = res.data;
  });
}
...
function chooseImgs(e) {
  ...
  document.getElementById('photos').addEventListener('change', function () {
    var input = document.getElementById("photos");
    document.getElementById('uploadBtn').classList.add('show');
    document.getElementById('uploadBtn').innerText = "T\xE9l\xE9charger ".concat(_toConsumableArray(input.files).length, " fichier(s)");
  });
}

function highlightPhoto(e) {
  var galeryId = e.target.parentNode.previousElementSibling.id.split('-')[1];
  var photoOrderId = e.target.parentNode.previousElementSibling.id.split('-')[2];
...
function allowDrag(e) {
  var type = e.target.parentNode.previousElementSibling.id.split('-')[0];
  ...
  if (type === 'category') {
    ...
    document.querySelectorAll('.galery-drop-zone').forEach(function (el) {
      el.classList.add('show');
    });
    document.querySelector('[draggable="true"]').previousElementSibling.classList.remove('show');
    document.querySelector('[draggable="true"]').nextElementSibling.classList.remove('show');
